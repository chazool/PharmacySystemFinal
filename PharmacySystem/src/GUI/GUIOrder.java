...
public class GUIOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        butSale.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                butSaleActionPerformed(evt);
            }
        });
    ...
    private void keyType(int key) {
        if (key == KeyEvent.VK_SPACE) {
            ...
            String val = OrderManager.newRowBarcode(txtItemName.getText().trim());

            txtItemName.setText(val);
        }
    }
    ...
    private void AddRow() {
        ...
        if (bool) {
            ...
            Stock stock = OrderManager.newRow(txtItemName.getText().trim());

            float price = stock.getResalePrice();

            float value = price * Integer.parseInt(txtQty.getText());
            // set Rwo
            ...
            if (lblTotal.getText().length() != 0) {
                tot = Float.parseFloat(lblTotal.getText().trim()) + value;
    ...
    private void butSaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butSaleActionPerformed
       
    }//GEN-LAST:event_butSaleActionPerformed
    ...
    private void txtPaymentKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPaymentKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            float tot = Float.parseFloat(lblTotal.getText().trim());
            float payment = Float.parseFloat(txtPayment.getText().trim());

            lblBalance.setText((payment - tot) + "");
        }
    ...
    private void tableItemKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tableItemKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_DELETE) {
            ...
            int SelectRow = tableItem.getSelectedRow();

            float tot = Float.parseFloat(lblTotal.getText().trim());
            float DelVal = Float.parseFloat(tableItem.getValueAt(SelectRow, 3).toString().trim());

            lblTotal.setText((tot - DelVal) + "");
